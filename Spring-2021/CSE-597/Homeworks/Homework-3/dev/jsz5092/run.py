...
def parse_args():
    ...
    model_settings.add_argument('--algo', choices=['BOW', 'GLOVE'], default='BOW', help='choose the input word vector algorithm to use')
    model_settings.add_argument('--lr', type=float, default=0.0001, help='learning rate')
    model_settings.add_argument('--hidden_size', type=int, default=5, help='the hidden size of the classifier')
    model_settings.add_argument('--embed_size', type=int, default=50, help='size of the glove embeddings')

    path_settings = parser.add_argument_group('path settings')
    path_settings.add_argument('--emb_file', default=['./glove/glove.6B.50d.txt'], help='Path of pre-trained input data')
    path_settings.add_argument('--review_file', default='./data/reviews.txt', help='Path of the input reviews text')
    path_settings.add_argument('--label_file', default='./data/labels.txt', help='Path of the input reviews label')
